...
public class ResultsActivity extends AppCompatActivity {
    ...
    private void showResults() {
        ...
        binding.tvStatus1.setText(answers.get(0) == questions.get(0).getCorrectIndex() ? "Correct" : "Incorrect");
        binding.tvStatus2.setText(answers.get(1) == questions.get(1).getCorrectIndex() ? "Correct" : "Incorrect");
        binding.tvStatus3.setText(answers.get(2) == questions.get(2).getCorrectIndex() ? "Correct" : "Incorrect");
    }
